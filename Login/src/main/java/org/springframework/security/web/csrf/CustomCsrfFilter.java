...
public final class CustomCsrfFilter extends OncePerRequestFilter {
	...
	private RequestMatcher defaultRequireCsrfProtectionMatcher = DEFAULT_CSRF_MATCHER;
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if (!this.defaultRequireCsrfProtectionMatcher.matches(request)) {
			if (this.logger.isTraceEnabled()) {
				this.logger.trace("Did not protect against CSRF since request did not match "
						+ this.defaultRequireCsrfProtectionMatcher);
			}
