...
import { StateData } from 'src/app/shared/interface/StateData';
...
@Component({
  selector: 'app-report-rfp1819',
  templateUrl: './report-rfp1819.component.html',
  styleUrls: ['./report-rfp1819.component.css']
})
export class ReportRfp1819Component implements OnInit {
...
formData.append("uploadFile",this.file);
    this.restClient.uploadFile(environment.SLAREPORTS_UPLOAD_RFP1819_API, formData).subscribe({
      next: (result: APIResponse) => {
