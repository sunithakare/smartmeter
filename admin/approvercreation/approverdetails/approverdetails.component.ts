...
export class ApproverDetailsComponent implements OnInit {
  ...
  ApproverDataAsFormGroup(approverData: ApproverDetail): FormGroup {
    ...
    const fg = new FormGroup({
      ...
      approverFilter: new FormControl(
        { value: approverData.approverFilter, disabled: !(this.isEditable && !(approverData.approverIdentity=="SPOC" || approverData.approverIdentity=="PROJECT_DIRECTOR"|| approverData.approverIdentity=="CLIENT_DIRECTOR" ||approverData.approverIdentity=="UPPCL_DISCOM_MANAGER" || approverData.approverIdentity=="UPPCL_CLIENT_MANAGER"))  }
      ),
      approvalFor: new FormControl(
        { value: approverData.approvalFor, disabled: !(this.isEditable && !(approverData.approverIdentity=="SPOC" || approverData.approverIdentity=="PROJECT_DIRECTOR"|| approverData.approverIdentity=="CLIENT_DIRECTOR" ||approverData.approverIdentity=="UPPCL_DISCOM_MANAGER" || approverData.approverIdentity=="UPPCL_CLIENT_MANAGER"))  }
        ),
    });
    return fg;
  }
  ...
  checkDisableSelection(event: MatSelectChange, index: number) {
    if(event.value=="SPOC" || event.value=="PROJECT_DIRECTOR"|| event.value=="CLIENT_DIRECTOR" ||event.value=="UPPCL_DISCOM_MANAGER" || event.value=="UPPCL_CLIENT_MANAGER"){
