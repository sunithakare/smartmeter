...
CREATE TABLE custom.BATCH_JOB_EXECUTION  (
	...
	references custom.BATCH_JOB_INSTANCE(JOB_INSTANCE_ID)
) ;
...
CREATE TABLE custom.BATCH_JOB_EXECUTION_PARAMS  (
	...
	references custom.BATCH_JOB_EXECUTION(JOB_EXECUTION_ID)
) ;
...
CREATE TABLE custom.BATCH_STEP_EXECUTION_CONTEXT  (
	...
	references custom.BATCH_STEP_EXECUTION(STEP_EXECUTION_ID)
) ;
...
CREATE SEQUENCE custom.BATCH_STEP_EXECUTION_SEQ MAXVALUE 9223372036854775807 NO CYCLE;
CREATE SEQUENCE custom.BATCH_JOB_EXECUTION_SEQ MAXVALUE 9223372036854775807 NO CYCLE;
CREATE SEQUENCE custom.BATCH_JOB_SEQ MAXVALUE 9223372036854775807 NO CYCLE;
