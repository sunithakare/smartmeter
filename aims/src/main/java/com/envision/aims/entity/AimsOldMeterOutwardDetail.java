...
@Entity
@Table(name = "aims_old_meter_outward_details")
@Getter
@Setter
@NoArgsConstructor
public class AimsOldMeterOutwardDetail {
    ...
    @Column(name = "old_meter_outward_id", nullable = false)
    private String oldMeterOutward;
